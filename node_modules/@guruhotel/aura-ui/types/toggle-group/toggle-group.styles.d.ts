...
export declare const StyledItem: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<ToggleGroupPrimitive.ToggleGroupItemProps & import("react").RefAttributes<HTMLButtonElement>>, {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
...
export declare const StyledToggleGroup: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<(ToggleGroupPrimitive.ToggleGroupSingleProps | ToggleGroupPrimitive.ToggleGroupMultipleProps) & import("react").RefAttributes<HTMLDivElement>>, {
