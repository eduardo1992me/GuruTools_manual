...
declare const StyledLabel: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<LabelPrimitive.LabelProps & import("react").RefAttributes<HTMLLabelElement>>, {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
