...
target_url = "https://hotelcasasantamaria.mx"
...
def monitoreoSitio_2023(main_url):
    ...
    for i in range(4):    
        if cycle == 0:
            ...
            target_url = main_url + f"/es/availability?checkout={date_chkout}&currency=MXN&occupancy=2&checkin={date_chkin}"
...
monitoreoSitio_2023(target_url)