            ...
            if cy == 0:
                ...
                if currency == "MXN":
                    ...
                    for a in range (len(list_price)):
                        ...
                        if price_raw is not None:
                            if price_raw[0:3] == "MXN":
                                print(f"Price Raw es{price_raw} en iteracion {a}")
                                clear_price = price_raw.replace(remove_cr, '')
                                list_price[a] = clear_price
                            print(f"La lista de precios limpia queda: {list_price}")
                elif currency == "USD":
                    remove_cr = "$"
                    for a in range (len(list_price)):
                        price_raw = list_price[a]
